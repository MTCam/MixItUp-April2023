...
\lstset{
  language=Python,
  basicstyle=\ttfamily\fontsize{5}{3.5}\selectfont,
...
{%
    \includegraphics[width=\paperwidth]{figures/ceesd-slide-background.pdf}%
}
...
\newcommand{\Mcom}{\progname{MIRGE-Com}}
